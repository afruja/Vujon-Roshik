<footer class="container-fluid">
   <div class="row links">
      <div class="col-md-3 col-sm-3 col-xs-6 linkBox">
         <ul class="address">
            <li><a href="mailto:iamkawsarlive@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i> email@gmail.com</a></li>
            <li><a href="tel:+8801738671782"><i class="fa fa-phone" aria-hidden="true"></i> +8801738671782</a></li>
            ...
            <li><a href=""><i class="fa fa-clock-o" aria-hidden="true"></i> 10am-11pm Everyday</a></li>
         </ul>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-6 linkBox">
         <ul>
   ...
   <div class="row footer-bottom">
      <p>All Rights Reserved 2020 ® <span>Vujon Roshik</span></p>
   </div>
